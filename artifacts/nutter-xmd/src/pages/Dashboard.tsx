...
const FEATURE_TOGGLES: FeatureToggle[] = [
  ...
  { key: "antiTag",     label: "Anti Tag",     description: "Delete & kick anyone who mentions this group in their status broadcast", icon: Tag,       category: "Protection", note: "Requires bot to be group admin" },
