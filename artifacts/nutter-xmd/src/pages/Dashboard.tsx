...
const FEATURE_TOGGLES: FeatureToggle[] = [
  ...
  { key: "antiTag",     label: "Anti Tag",     description: "Delete any message that contains @mentions in the group", icon: Tag,       category: "Protection", note: "Requires bot to be group admin" },
